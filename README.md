...
Incluye la relación entre tablas utilizando consultas SQL, lo que permite organizar correctamente los turnos.

También se realizaron pruebas funcionales básicas (QA manual) para validar el correcto funcionamiento del sistema.
